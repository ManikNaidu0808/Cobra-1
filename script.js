...
function main(ctime) {
    ...
    /* requestAnimationFrame produces higher quality animation completely
    eliminating flicker and shear that can happen when using setTimeout or setInterval */
    // console.log(ctime)
...
function gameEngine() {
    ...
    if (snakeArr[0].y === food.y && snakeArr[0].x === food.x) {
        ...
        let a = 2;
        let b = 16;
        food = {x: Math.round(a + (b-a)* Math.random()) , y: Math.round(a + (b-a)* Math.random())} //random no. between a to b
    }
